...
Write a C/C++ program that can detect whether the given sentence is grammatically correct or
not.*/
...
int main()
{
	char *str[] = { "I like to drink tea.", "I need a Pen.",
					"My name is JEba FAWjia.",
					"Phython. is a quiz site.",
					"I love quiz and Geeksforgeeks.",
